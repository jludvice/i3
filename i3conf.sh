...
curl -L -o weather.zip https://github.com/erikflowers/weather-icons/archive/master.zip
...
mv /tmp/weather-icons-master/font/weathericons-regular-webfont.ttf ~/.fonts
...
ln -s $BASE_DIR/weather.sh /home/avano/.config/i3/weather.sh
