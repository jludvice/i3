...
sudo apt-get install i3 i3blocks rofi compton lxappearance feh scrot imagemagick arandr xfce4-power-manager thunar git cpanminus libgtk2-perl libgtk3-perl geany
...
unzip i3blockscontrib.zip -d ~/.i3/scripts
